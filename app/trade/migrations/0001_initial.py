# Generated by Django 2.0.2 on 2019-08-12 09:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.goods.Goods', verbose_name='商品')),
            ],
            options={
                'verbose_name': '订单商品',
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='goods', to='app.trade.OrderInfo', verbose_name='订单信息'),
        ),
